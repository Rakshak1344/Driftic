...
abstract class $PointCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int position, DateTime createdAt});
}
...
class _$PointImpl implements _Point {
  const _$PointImpl(
      {required this.id, required this.position, required this.createdAt});
  ...
  @override
  String toString() {
    return 'Point(id: $id, position: $position, createdAt: $createdAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, position, createdAt);
...
abstract class _Point implements Point {
  const factory _Point(
      ...
      required final DateTime createdAt}) = _$PointImpl;
