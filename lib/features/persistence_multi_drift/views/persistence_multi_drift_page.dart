...
import 'package:driftic/features/persistence_multi_drift/data/point_state.dart';
import 'package:driftic/features/persistence_multi_drift/data/points_combine_state.dart';
...
class PersistenceMultiDriftPage extends ConsumerStatefulWidget {
  const PersistenceMultiDriftPage({super.key});

  @override
  ConsumerState createState() => _PersistenceMultiDriftPageState();
}

class _PersistenceMultiDriftPageState
    extends ConsumerState<PersistenceMultiDriftPage>
  ...
  Future<void> addToDoItem() async {
    ...
    if (_tabController.index == 3) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("Cannot add")));
      return;
    }
